...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load('mathRecognizerMx_4epochw20kBgrd.pt'))


    trainDir = r'C:\Users\maxwe\Desktop\My Documents\MathExprSolverMx\MathExprSolverMx\whiteboardImages'
    testDir = r'C:\Users\maxwe\Desktop\My Documents\MathExprSolverMx\MathExprSolverMx\AidaCalculusHandWrittenMathDataset\archive\miniSet'
    ...
    savePath = os.path.join(os.getcwd(), 'mathRecognizerMx_4epochw20kBgrd_WB.pt')
